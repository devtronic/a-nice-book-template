...
% pandoc sets \setmainfont{Inter} from book.yaml.
% We use Inter Display (the display optical size) for chapter/section headings.
...
% ── Code listing style ───────────────────────────────────────────
\input{templates/latex/code-listing-style.tex}
...
% Section: Inter Display SemiBold with subtle left accent bar
\titleformat{\section}
...
% Subsection: Inter SemiBold, no number decoration
